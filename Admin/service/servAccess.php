...
class servAccess
{
     ...
     * @return servAccess
     */
    public static function sole($uid, $scope)
    {
        return self::_sole($uid, $scope);
    }
     ...
     * @return array
     */
    public function getAuths($uid)
    {
        $res = dataScopeUser::sole()->fetchByUid($uid);
        $groupAuth = dataScopeGroup::sole()->fetchAuths(...$res['groups']);

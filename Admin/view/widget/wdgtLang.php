...
class wdgtLang
{
    public static function switchDropdown()
    {
        ...
        $lang = Language::ALIAS[servSession::sole()->lang] ?? servSession::sole()->lang;
    ...
    {
        return Language::file(servSession::sole()->lang, $path);
    }

    public static function base($key)
    {
        return Language::sole(servSession::sole()->lang, ['base'])->refer($key);
    }
    
    public static function menu($key)
    {
        return Language::sole(servSession::sole()->lang, ['base', 'menu'])->refer($key);
    }

    public static function dict($key)
    {
        return Language::sole(servSession::sole()->lang, ['base', 'dict'])->refer($key);
    }
